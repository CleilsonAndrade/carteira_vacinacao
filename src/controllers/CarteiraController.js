...
module.exports = {
  async store(req, res) {
    const { numero_paciente, coren_enfermeiro, numero_cnes, data_aplicacao, id_vacina } = req.body
    ...
    const carteira = await Carteira.sequelize.query('CALL sp_cadastrarCarteira(:paciente_numero, :coren_enfermeiro, :numero_cnes, :id_vacina, :data_aplicacao)', {
      replacements: {
